...
//               className={`btn ${lastClicked === 'know' ? 'btn-know' : 'btn-normal'}`}
//             >
//               I Know This
//             </button>
//             <button
//               onClick={handleDontKnowClick}
//               className={`btn ${lastClicked === 'dontKnow' ? 'btn-dont-know' : 'btn-normal'}`}
//             >
//               I Don't Know This
//             </button>
//           </div>
...
const FlashcardList = ({ category }) => {
  ...
  return (
    <div className="container-full-height">
      <div className="row mb-4">
        {currentFlashcards.map((flashcard, index) => (
          <div key={currentPage * cardsPerPage + index} className="col col-md-8 col-lg-6">
            <FlashcardItem
